...
RULES: list[Rule] = [
    ...
    Rule(
        ...
        # branch name like `task/PROJ-032-fix-...` or `feature-fix`.
        pattern=re.compile(
            r"\bgit\s+push\b[\s\S]*"
    ...
    Rule(
        ...
        # not embedded in a branch name like `PROJ-032-dfx-feature` or
    ...
    Rule(
        ...
        # embedded in branch/file names like `feature-c`, `PROJ-01-config`,
        # or `auto-config`.
        pattern=re.compile(
            r"\bgit\b[\s\S]*"
    ...
    Rule(
        ...
        # like `git clean -n some-file` or `PROJ-032-fix` (`-file`/`-fix`
