...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "git push origin task/PROJ-032-fix-remaining-test-failures",
            "git-push-denied",
        ...
        pytest.param(
            "git push origin task/PROJ-01-feature",
            "git-push-denied",
        ...
        pytest.param(
            "git branch -d task/PROJ-032-dfx-feature",
            None,
        ...
        pytest.param(
            "git commit -m 'PROJ-01-config work'",
            None,
            id="commit-numeric-dash-config-message-allowed",
        ),
        pytest.param(
            "git log task/PROJ-01-config",
            None,
        ...
        pytest.param(
            "git clean -n task/PROJ-032-fix-remaining-test-failures",
            None,
