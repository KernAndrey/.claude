...
Examples:
    batch_implement.py ~/projects/myproject
    batch_implement.py ~/projects/myproject --retries 2
    batch_implement.py ~/projects/myproject PROJ-013 PROJ-010
"""
